package com.qdd.compressionanddecompression.util;
...
public class CompressionAndDecompressionUtils {
	...
	public static void main(String[] args) {
		String path="E:/test/demo";
		String[] files=new String[3];
		files[0]="E:/test/demo/x/x.txt";
//		files[0]="E:/test/demo/a1.txt";
		files[1]="E:/test/demo/a2.txt";
		files[2]="E:/test/demo/a3.txt";
		try {
			zipCompression(files,"E:/test/demo/zip/testZip1.zip");
			zipDecompression("E:/test/demo/zip/testZip1.zip","E:/test/demo/unzip");
		} catch (Exception e) {
			e.printStackTrace();
		}
//
//		try {
//			tarCompression(files,"E:/test/demo/zip/testZip.tar");
//			tarDecompression("E:/test/demo/zip/testZip.tar","E:/test/demo/unzip");
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
